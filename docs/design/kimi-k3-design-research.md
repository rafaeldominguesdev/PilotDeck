...
Card: [OCL-81](https://github.com/rafaeldominguesdev/pilotdeck) — "Design system do
PilotDeck (K3)", harness `kimi/k3/max`, commit `74f7b83`, custo medido
...
- [OCL-56](https://github.com/rafaeldominguesdev/pilotdeck) (origem): *"k3 do
...
- [OCL-57](https://github.com/rafaeldominguesdev/pilotdeck): mesmo padrão — "k3 caiu
  por limite; há trabalho parcial NÃO commitado no worktree".
- [OCL-115/116/117](https://github.com/rafaeldominguesdev/pilotdeck) (as 3 "bancadas"
...
- Cards internos PilotDeck: OCL-81, OCL-56, OCL-57, OCL-115, OCL-116, OCL-117
  (board `pilotdeck`, consultados 21/08/2026)
