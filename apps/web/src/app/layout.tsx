    ...
    <html lang="en" data-theme={DEFAULT_THEME}>
      <head>
        {/*
          ...
          the browser is still parsing <head>, so a person who chose overclock
          never sees devterm flash past on the way in. It is inline on purpose:
          an external file would be a network round trip in front of the paint,
