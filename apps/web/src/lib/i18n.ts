...
const en = {
  ...
  board: {
     ...
     * "pilotdeck" alone tells a screen reader the brand, not the destination.
     */
    homeLink: "pilotdeck, go to the board",
    colOpen: "Open",
  ...
  plugin: {
    ...
    lead:
      "One command sets the PilotDeck plugin up on this machine: MCP access, the board skill, the lifecycle hooks and the /pilotdeck commands, on Claude Code, Codex, Grok and Kimi, whichever of them it finds.",
  ...
  updates: {
    ...
    stepNote: {
      ...
      "restart-manual":
        "Restart the process yourself to finish. Set PILOTDECK_RESTART_ON_UPDATE=1 to let the board exit for a supervisor instead.",
    } as Record<string, string>,
...
const ptBR: Dict = {
  lang: "pt-BR" as Lang,
  board: {
    homeLink: "pilotdeck, ir para o board",
    colOpen: "Aberto",
  ...
  plugin: {
    ...
    lead:
      "Um comando instala o plugin do PilotDeck nesta máquina: acesso MCP, a skill do board, os hooks de ciclo de vida e os comandos /pilotdeck, no Claude Code, Codex, Grok e Kimi, os que ele encontrar.",
  ...
  updates: {
    ...
    stepNote: {
      ...
      "restart-manual":
        "Reinicie o processo na mão para concluir. Defina PILOTDECK_RESTART_ON_UPDATE=1 para o board sair sozinho e deixar um supervisor subir de volta.",
    } as Record<string, string>,
